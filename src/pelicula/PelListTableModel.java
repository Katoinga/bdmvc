...
public class PelListTableModel extends AbstractTableModel {
    ...
    public PelListTableModel() {
        ...
        try {
            ...
            GenListRowSet.setCommand("SELECT * FROM pelicula");
    ...
    public PelListTableModel(RowSet rowSet, Connection conn) {
        try {
    ...
    public boolean isPrimaryKeyInDB(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("PelCod").equals(array[1]))
    ...
    public void addRow(Object[] array) {
        try {
            ...
            if (!isPrimaryKeyInDB(array)) {
                ...
                GenListRowSet.updateString("PelDur", (String) array[5]);
                GenListRowSet.updateString("PelNacCod", (String) array[6]);
                GenListRowSet.updateString("PelEstReg", (String) array[7]);
    ...
    public void deleteRow(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("PelCod").equals(array[1])) {
                	GenListRowSet.updateString("PelEstReg", "*");
    ...
    public void updateRow(Object[] array, JTable jtable) {
        try {
            ...
            String selectedGenNumber = GenListRowSet.getString("PelCod");
    ...
    public void activateRow(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("PelCod").equals(array[1])) {
                	GenListRowSet.updateString("PelEstReg", "A");
    ...
    public void inactivateRow(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("PelCod").equals(array[1])) {
                	GenListRowSet.updateString("PelEstReg", "I");
    ...
    public static void main(String[] args) {
        ...
        PelListGUI PelListGUI = new PelListGUI();
        PelListGUI.setVisible(true);
    }
}