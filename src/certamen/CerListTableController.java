...
public class CerListTableController implements ListSelectionListener, RowSetListener {
    
    private CerListTableModel tableModel = null;
    private CerListGUI gui;
    
    public CerListTableController(CerListGUI gui) {
        this.gui = gui;
        // Create the tableModel using the data in the cachedRowSet
        tableModel = new CerListTableModel();
    ...
    public void rowChanged(RowSetEvent event) {
        try {
            ...
            tableModel = new CerListTableModel(tableModel.getRowSet(), tableModel.getConnection());
