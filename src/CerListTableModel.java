...
public class CerListTableModel extends AbstractTableModel {
    ...
    public CerListTableModel() {
        ...
        try {
            ...
            GenListRowSet.setCommand("SELECT * FROM certamen");
    ...
    public CerListTableModel(RowSet rowSet, Connection conn) {
        try {
    ...
    public boolean isPrimaryKeyInDB(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("CerCod").equals(array[1]))
    ...
    public void addRow(Object[] array) {
        try {
            ...
            if (!isPrimaryKeyInDB(array)) {
                GenListRowSet.last();
                GenListRowSet.moveToInsertRow();
                GenListRowSet.updateString("CerNom", (String) array[0]);
                GenListRowSet.updateString("CerCod", (String) array[1]);
                GenListRowSet.updateString("CerFesCod", (String) array[2]);
                GenListRowSet.updateString("CerOrgCod", (String) array[3]);
                GenListRowSet.updateString("CerEstReg", (String) array[4]);
    ...
    public void deleteRow(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("CerCod").equals(array[1])) {
                	GenListRowSet.updateString("CerEstReg", "*");
    ...
    public void updateRow(Object[] array, JTable jtable) {
        try {
            ...
            String selectedGenNumber = GenListRowSet.getString("CerCod");
    ...
    public void activateRow(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("CerCod").equals(array[1])) {
                	GenListRowSet.updateString("CerEstReg", "A");
    ...
    public void inactivateRow(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("CerCod").equals(array[1])) {
                	GenListRowSet.updateString("CerEstReg", "I");
    ...
    public static void main(String[] args) {
        ...
        CerListGUI CerListGUI = new CerListGUI();
        CerListGUI.setVisible(true);
    }
}