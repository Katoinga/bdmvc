...
public class OrgListTableModel extends AbstractTableModel {
    ...
    public OrgListTableModel() {
        ...
        try {
            ...
            GenListRowSet.setCommand("SELECT * FROM organizacion");
    ...
    public OrgListTableModel(RowSet rowSet, Connection conn) {
        try {
    ...
    public boolean isPrimaryKeyInDB(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("OrgCod").equals(array[1]))
    ...
    public void addRow(Object[] array) {
        try {
            ...
            if (!isPrimaryKeyInDB(array)) {
                GenListRowSet.last();
                GenListRowSet.moveToInsertRow();
                GenListRowSet.updateString("OrgNom", (String) array[0]);
                GenListRowSet.updateString("OrgCod", (String) array[1]);
                GenListRowSet.updateString("OrgEstReg", (String) array[2]);
    ...
    public void deleteRow(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("OrgCod").equals(array[1])) {
                	GenListRowSet.updateString("OrgEstReg", "*");
    ...
    public void updateRow(Object[] array, JTable jtable) {
        try {
            ...
            String selectedGenNumber = GenListRowSet.getString("OrgCod");
            ...
            JOptionPane.showMessageDialog(null,
                    "Cannot have multiple records with the same primary key (OrgCod).",
                    "Primary Key Error", JOptionPane.ERROR_MESSAGE);
    ...
    public void activateRow(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("OrgCod").equals(array[1])) {
                	GenListRowSet.updateString("OrgEstReg", "A");
    ...
    public void inactivateRow(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("OrgCod").equals(array[1])) {
                	GenListRowSet.updateString("OrgEstReg", "I");
    ...
    public static void main(String[] args) {
        ...
        OrgListGUI OrgListGUI = new OrgListGUI();
        OrgListGUI.setVisible(true);
    }
