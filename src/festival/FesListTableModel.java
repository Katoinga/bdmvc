...
public class FesListTableModel extends AbstractTableModel {
    ...
    public FesListTableModel() {
        ...
        try {
            ...
            GenListRowSet.setCommand("SELECT * FROM festival");
    ...
    public FesListTableModel(RowSet rowSet, Connection conn) {
        try {
    ...
    public boolean isPrimaryKeyInDB(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("FesCod").equals(array[1]))
    ...
    public void addRow(Object[] array) {
        try {
            ...
            if (!isPrimaryKeyInDB(array)) {
                GenListRowSet.last();
                GenListRowSet.moveToInsertRow();
                GenListRowSet.updateString("FesNom", (String) array[0]);
                GenListRowSet.updateString("FesCod", (String) array[1]);
                GenListRowSet.updateString("FesFun", (String) array[2]);
                GenListRowSet.updateString("FesEstReg", (String) array[3]);
    ...
    public void deleteRow(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("FesCod").equals(array[1])) {
                	GenListRowSet.updateString("FesEstReg", "*");
    ...
    public void updateRow(Object[] array, JTable jtable) {
        try {
            ...
            String selectedGenNumber = GenListRowSet.getString("FesCod");
    ...
    public void activateRow(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("FesCod").equals(array[1])) {
                	GenListRowSet.updateString("FesEstReg", "A");
    ...
    public void inactivateRow(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("FesCod").equals(array[1])) {
                	GenListRowSet.updateString("FesEstReg", "I");
    ...
    public static void main(String[] args) {
        ...
        FesListGUI FesListGUI = new FesListGUI();
        FesListGUI.setVisible(true);
    }
