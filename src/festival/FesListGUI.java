...
public class FesListGUI extends javax.swing.JFrame {

    private JTable jtable1; // The table displayed on the GUI
    private FesListTableController fesListTableController = null;
    ...
    public FesListGUI() {
        ...
        fesListTableController = new FesListTableController(this);
    ...
    public void addJTable() {
        ...
        jtable1 = new JTable(fesListTableController.getTableModel());
    
        // Add a ListSelectionListener to the table
        jtable1.getSelectionModel().addListSelectionListener(fesListTableController);
    ...
    public void updateTable() {
        jtable1.setModel(fesListTableController.getTableModel());
    }
    ...
    // Set data on the GenFesFunTextField
    public void setGenFesFunTextField(String value) { GenFesFunTextField.setText(value); }
    
 // Set data on the GenTipTarSexCodTextField
    public void setGenFesEstRegTextField(String value) { GenFesEstRegTextField.setText(value); }
    ...
    private void initComponents() {
        ...
        GenFesFunLabel = new javax.swing.JLabel();
        GenFesEstRegLabel = new javax.swing.JLabel();

        GenNameTextField = new javax.swing.JTextField();
        GenNumberTextField = new javax.swing.JTextField();
        GenFesFunTextField = new javax.swing.JTextField();
        GenFesEstRegTextField = new javax.swing.JTextField();
        ...
        GenFesFunLabel.setText("Fundacion: ");
        GenFesEstRegLabel.setText("Estado Registro: ");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(GenFesFunLabel)
                    .addGap(161, 161, 161)
                    .addComponent(GenFesFunTextField)
                    .addContainerGap())
            .addGroup(jPanel1Layout.createSequentialGroup()
                    .addContainerGap()
                    .addComponent(GenFesEstRegLabel)
                    .addGap(161, 161, 161)
                    .addComponent(GenFesEstRegTextField)
                    .addContainerGap())
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(30, 30, 30)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(GenFesFunTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addComponent(GenFesFunLabel))
                    .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                          .addComponent(GenFesEstRegTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                         .addComponent(GenFesEstRegLabel))
                .addGap(18, 18, 18)    
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(addButton)
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        ...
        array[2] = GenFesFunTextField.getText();
        array[3] = GenFesEstRegTextField.getText();
        
        // Send data to the controller to add it to the model
        fesListTableController.addRow(array);
    }//GEN-LAST:event_addButtonActionPerformed

    // Code for the delete button
    // NEED TO FINISH MAKING THIS. SEE addRow() METHODS IN
    // fesListTableController.java (LINE 65) and CouseListTableModel.java (LINE 149)
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        fesListTableController.deleteRow(array);
    ...
    // NEED TO FINISH MAKING THIS. SEE addRow() METHODS IN
    // fesListTableController.java (LINE 66) and CouseListTableModel.java (LINE 248)
    private void actButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        fesListTableController.activateRow(array);
    }//GEN-LAST:event_activateButtonActionPerformed
    
    // Code for the inactivate button
    // NEED TO FINISH MAKING THIS. SEE addRow() METHODS IN
    // fesListTableController.java (LINE 71) and CouseListTableModel.java (LINE 268)
    ...
    private void modButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        array[2] = GenFesFunTextField.getText();
        array[3] = GenFesEstRegTextField.getText();
        fesListTableController.updateRow(array, jtable1);
    ...
    private javax.swing.JLabel GenFesFunLabel;
    private javax.swing.JTextField GenFesFunTextField;
    private javax.swing.JLabel GenFesEstRegLabel;
    private javax.swing.JTextField GenFesEstRegTextField;
