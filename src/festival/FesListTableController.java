...
public class FesListTableController implements ListSelectionListener, RowSetListener {
    
    private FesListTableModel tableModel = null;
    private FesListGUI gui;
    
    public FesListTableController(FesListGUI gui) {
        this.gui = gui;
        // Create the tableModel using the data in the cachedRowSet
        tableModel = new FesListTableModel();
    ...
    public void valueChanged(ListSelectionEvent e) {
        ...
        if (!e.getValueIsAdjusting()) {
            ...
            gui.setGenFesFunTextField((String) tableModel.getValueAt(firstIndex, 2));
            gui.setGenFesEstRegTextField((String) tableModel.getValueAt(firstIndex, 3));
        }
    }
    ...
    public void rowChanged(RowSetEvent event) {
        try {
            ...
            tableModel = new FesListTableModel(tableModel.getRowSet(), tableModel.getConnection());
