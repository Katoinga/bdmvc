...
public class FesPreListTableController implements ListSelectionListener, RowSetListener {
    
    private FesPreListTableModel tableModel = null;
    private FesPreListGUI gui;
    
    public FesPreListTableController(FesPreListGUI gui) {
        this.gui = gui;
        // Create the tableModel using the data in the cachedRowSet
        tableModel = new FesPreListTableModel();
    ...
    public void rowChanged(RowSetEvent event) {
        try {
            ...
            tableModel = new FesPreListTableModel(tableModel.getRowSet(), tableModel.getConnection());
