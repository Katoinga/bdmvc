...
public class FesPreListTableModel extends AbstractTableModel {
    ...
    public FesPreListTableModel() {
        ...
        try {
            ...
            GenListRowSet.setCommand("SELECT * FROM festival_premio");
    ...
    public FesPreListTableModel(RowSet rowSet, Connection conn) {
        try {
    ...
    public boolean isPrimaryKeyInDB(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("FesPreCod").equals(array[1]))
    ...
    public void addRow(Object[] array) {
        try {
            ...
            if (!isPrimaryKeyInDB(array)) {
                GenListRowSet.last();
                GenListRowSet.moveToInsertRow();
                GenListRowSet.updateString("FesPreGal", (String) array[0]);
    ...
    public void deleteRow(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("FesPreCod").equals(array[1])) {
                	GenListRowSet.updateString("FesPreEstReg", "*");
    ...
    public void updateRow(Object[] array, JTable jtable) {
        try {
            ...
            String selectedGenNumber = GenListRowSet.getString("FesPreCod");
    ...
    public void activateRow(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("FesPreCod").equals(array[1])) {
                	GenListRowSet.updateString("FesPreEstReg", "A");
    ...
    public void inactivateRow(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("FesPreCod").equals(array[1])) {
                	GenListRowSet.updateString("FesPreEstReg", "I");
    ...
    public static void main(String[] args) {
        ...
        FesPreListGUI FesPreListGUI = new FesPreListGUI();
        FesPreListGUI.setVisible(true);
    }
}