...
public class OtoListTableModel extends AbstractTableModel {
    ...
    public OtoListTableModel() {
        ...
        try {
            ...
            GenListRowSet.setCommand("SELECT * FROM otorgo");
    ...
    public OtoListTableModel(RowSet rowSet, Connection conn) {
        try {
    ...
    public boolean isPrimaryKeyInDB(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("OtoCod").equals(array[1]))
    ...
    public void deleteRow(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("OtoCod").equals(array[1])) {
                	GenListRowSet.updateString("OtoEstReg", "*");
    ...
    public void updateRow(Object[] array, JTable jtable) {
        try {
            ...
            String selectedGenNumber = GenListRowSet.getString("OtoCod");
    ...
    public void activateRow(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("OtoCod").equals(array[1])) {
                	GenListRowSet.updateString("OtoEstReg", "A");
    ...
    public void inactivateRow(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("OtoCod").equals(array[1])) {
                	GenListRowSet.updateString("OtoEstReg", "I");
    ...
    public static void main(String[] args) {
        ...
        OtoListGUI OtoListGUI = new OtoListGUI();
        OtoListGUI.setVisible(true);
    }
}