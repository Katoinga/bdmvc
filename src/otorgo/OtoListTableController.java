...
public class OtoListTableController implements ListSelectionListener, RowSetListener {
    
    private OtoListTableModel tableModel = null;
    private OtoListGUI gui;
    
    public OtoListTableController(OtoListGUI gui) {
        this.gui = gui;
        // Create the tableModel using the data in the cachedRowSet
        tableModel = new OtoListTableModel();
    ...
    public void rowChanged(RowSetEvent event) {
        try {
            ...
            tableModel = new OtoListTableModel(tableModel.getRowSet(), tableModel.getConnection());
