...
public class CinListTableController implements ListSelectionListener, RowSetListener {
    
    private CinListTableModel tableModel = null;
    private CinListGUI gui;
    
    public CinListTableController(CinListGUI gui) {
        this.gui = gui;
        // Create the tableModel using the data in the cachedRowSet
        tableModel = new CinListTableModel();
    ...
    public void valueChanged(ListSelectionEvent e) {
        ...
        if (!e.getValueIsAdjusting()) {
            ...
            gui.setGenCinCiuTextField((String) tableModel.getValueAt(firstIndex, 2));
            gui.setGenCinDirTextField((String) tableModel.getValueAt(firstIndex, 3));
            gui.setGenCinEstRegTextField((String) tableModel.getValueAt(firstIndex, 4));
        }
    }
    ...
    public void rowChanged(RowSetEvent event) {
        try {
            ...
            tableModel = new CinListTableModel(tableModel.getRowSet(), tableModel.getConnection());
