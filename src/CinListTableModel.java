...
public class CinListTableModel extends AbstractTableModel {
    ...
    public CinListTableModel() {
        ...
        try {
            ...
            GenListRowSet.setCommand("SELECT * FROM cine");
    ...
    public CinListTableModel(RowSet rowSet, Connection conn) {
        try {
    ...
    public boolean isPrimaryKeyInDB(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("CinCod").equals(array[1]))
    ...
    public void addRow(Object[] array) {
        try {
            ...
            if (!isPrimaryKeyInDB(array)) {
                GenListRowSet.last();
                GenListRowSet.moveToInsertRow();
                GenListRowSet.updateString("CinNom", (String) array[0]);
                GenListRowSet.updateString("CinCod", (String) array[1]);
                GenListRowSet.updateString("CinCiu", (String) array[2]);
                GenListRowSet.updateString("CinDir", (String) array[3]);
                GenListRowSet.updateString("CinEstReg", (String) array[4]);
    ...
    public void deleteRow(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("CinCod").equals(array[1])) {
                	GenListRowSet.updateString("CinEstReg", "*");
    ...
    public void updateRow(Object[] array, JTable jtable) {
        try {
            ...
            String selectedGenNumber = GenListRowSet.getString("CinCod");
    ...
    public void activateRow(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("CinCod").equals(array[1])) {
                	GenListRowSet.updateString("CinEstReg", "A");
    ...
    public void inactivateRow(Object[] array) {
        try {
            ...
            while (GenListRowSet.next()) {
                if (GenListRowSet.getString("CinCod").equals(array[1])) {
                	GenListRowSet.updateString("CinEstReg", "I");
    ...
    public static void main(String[] args) {
        ...
        CinListGUI CinListGUI = new CinListGUI();
        CinListGUI.setVisible(true);
    }
}